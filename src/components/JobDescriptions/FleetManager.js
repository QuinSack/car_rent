...
const FleetManager = () => {
  return (
    <div className='jobapp'>
        ...
        Ensure compliance with local, state, and federal regulations governing fleet operations.
        <b>- Team Leadership:</b>
        Lead and mentor a team of drivers, mechanics, and administrative staff.
        Conduct regular training sessions to enhance the skills and safety awareness of the fleet team.
        Foster a positive and collaborative work environment.
        <b>- Asset Management:</b>
        Manage vehicle procurement, disposal, and replacement strategies.
        Implement preventive maintenance programs to optimize vehicle lifespan and performance.
        Utilize fleet management software to track and analyze fleet performance metrics.
        <b>- Cost Management:</b>
        Develop and manage the fleet budget, including fuel costs, maintenance expenses, and capital expenditures.
        Identify cost-saving opportunities and implement strategies to improve overall operational efficiency.
