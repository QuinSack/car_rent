...
const CustomerSupport = () => {
  return (
    <div className='jobapp'>
        ...
        Address and resolve customer concerns, complaints, and inquiries with empathy and professionalism.
        <b>- Technical Assistance:</b>
        Assist customers in troubleshooting and resolving technical issues.
        Collaborate with the technical support team to ensure timely resolution of complex problems.
        ...
        Maintain a deep understanding of our products/services to provide comprehensive support.
        Stay informed about product updates, changes, and promotions.
