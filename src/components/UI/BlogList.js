                ...
                <div className='blog__info p-3'>
                    ...
                    <div className='blog__item pt-3 mt-3 d-flex align-items-center justify-content-between'>
                        ...
                        <div className='d-flex align-items-center gap-3'>
                            <span className='d-flex align-items-center gap-1 section__description'><i class="ri-calendar-line"></i> {date}</span>
                            <span className='d-flex align-items-center gap-1 section__description'><i class="ri-time-line"></i> {time}</span>
                        </div>
                    </div>
                </div>
            </div>
